...
func (app *application) registerUserHandler(w http.ResponseWriter, r *http.Request) {
	...
	err = app.stores.Users.Insert(user)
	if err != nil {
		switch {
...
func (app *application) activateUserHandler(w http.ResponseWriter, r *http.Request) {
	...
	user, err := app.stores.Users.GetForToken(data.ScopeActivation, input.TokenPlaintext)
	if err != nil {
		switch {
	...
	// user.
	err = app.stores.Tokens.DeleteAllForUser(data.ScopeActivation, user.ID)
	if err != nil {
		app.serverErrorResponse(w, r, err)
		return
	}
