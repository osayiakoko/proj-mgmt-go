...
// "tasks:read" and "tasks:write") for a single user.
...
// Define the PermissionStore type.
...
// an SQL query.
func (m PermissionStore) GetAllForUser(userID int64) (Permissions, error) {
	query := `
...
// single call.
func (m PermissionStore) AddForUser(userID int64, codes ...string) error {
	query := `
