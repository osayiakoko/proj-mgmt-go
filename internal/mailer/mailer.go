...
// IMMEDIATELY ABOVE it, which indicates to Go that we want to store the contents of the // ./templates directory in the templateFS embedded file system variable.
// ↓↓↓
...
func (m Mailer) Send(recipient, templateFile string, data interface{}) error {
	...
	// error. Try sending the email up to three times before aborting and returning
	// the final error. We sleep for 500 milliseconds between each attempt.
	for i := 1; i <= 3; i++ {
